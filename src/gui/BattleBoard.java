...
public class BattleBoard extends JLayeredPane implements MouseListener, MouseMotionListener, Refresh, Boat {
    ...
    public void setRefreshBounds(int widthDimension, int heightDimension) {
        if (widthDimension == 300) {
            battleBoard.setBounds(360, 30, widthDimension, heightDimension);
            row.setBounds(330, 0, 30 + widthDimension, 30);
            column.setBounds(330, 30, 30, 30 + heightDimension);
        } else {
            battleBoard.setBounds(60, 55, widthDimension, heightDimension);
            row.setBounds(0, 0, 60 + widthDimension, 55);
            column.setBounds(0, 55, 60, 60 + heightDimension);
        }
    }
    ...
    public BattleBoard() {
        ...
        row.setBounds(0, 0, rowSize.width + boardSize.width, rowSize.height);
        ...
        column.setBounds(0, 55, columnSize.width, columnSize.height + boardSize.height);
        ...
        battleBoard.setBounds(60, 55, boardSize.width, boardSize.height);
    ...
    public void mousePressed(MouseEvent e) {
        ...
        shipPiece1.setLocation(e.getX() + xAdjustment + 60, e.getY() + yAdjustment + 55);
        ...
        for (int i = 60; i <= 240; i = i + 60) {
            if (battleBoard.findComponentAt(e.getX() + i, e.getY()) instanceof JLabel) {
                if (shipPiece2 == null) {
                    ...
                    shipPiece2.setLocation(e.getX() + xAdjustment + 60 + i, e.getY() + yAdjustment + 55);
                } else if (shipPiece3 == null) {
                    shipPiece3 = (JLabel) battleBoard.findComponentAt(e.getX() + i, e.getY());
                    shipPiece3.setLocation(e.getX() + xAdjustment + 60 + i, e.getY() + yAdjustment + 55);
                } else if (shipPiece4 == null) {
                    shipPiece4 = (JLabel) battleBoard.findComponentAt(e.getX() + i, e.getY());
                    shipPiece4.setLocation(e.getX() + xAdjustment + 60 + i, e.getY() + yAdjustment + 55);
                } else if (shipPiece5 == null) {
                    shipPiece5 = (JLabel) battleBoard.findComponentAt(e.getX() + i, e.getY());
                    shipPiece5.setLocation(e.getX() + xAdjustment + 60 + i, e.getY() + yAdjustment + 55);
                }
                contDireita++;
            } else break;
        }
            ...
            for (int i = 60; i <= 240; i = i + 60) {
                if (battleBoard.findComponentAt(e.getX(), e.getY() + i) instanceof JLabel) {
                    if (shipPiece2 == null) {
                        ...
                        shipPiece2.setLocation(e.getX() + xAdjustment + 60, e.getY() + yAdjustment + 55 + i);
                    } else if (shipPiece3 == null) {
                        shipPiece3 = (JLabel) battleBoard.findComponentAt(e.getX(), e.getY() + i);
                        shipPiece3.setLocation(e.getX() + xAdjustment + 60, e.getY() + yAdjustment + 55 + i);
                    } else if (shipPiece4 == null) {
                        shipPiece4 = (JLabel) battleBoard.findComponentAt(e.getX(), e.getY() + i);
                        shipPiece4.setLocation(e.getX() + xAdjustment + 60, e.getY() + yAdjustment + 55 + i);
                    } else if (shipPiece5 == null) {
                        shipPiece5 = (JLabel) battleBoard.findComponentAt(e.getX(), e.getY() + i);
                        shipPiece5.setLocation(e.getX() + xAdjustment + 60, e.getY() + yAdjustment + 55 + i);
                    }
                    contCima++;
                } else break;
            }
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        int x = e.getX() + xAdjustment + 60;
        int xMax = battleBoard.getWidth() - shipPiece1.getWidth() + 60;
        x = Math.min(x, xMax - 60 * contDireita);
        x = Math.max(x, 60 * (contEsquerda + 1));
        ...
        for (int i = 1, j = 60; i <= contDireita; i++, j = j + 60) {
            if (i == 1 && shipPiece2 != null) {
                x = e.getX() + xAdjustment + 60;
                xMax = battleBoard.getWidth() - shipPiece2.getWidth() + 60;
                x = Math.min(x, xMax - 60 * (contDireita));
                x = Math.max(x, 60 * (contEsquerda + 1));
